...
if [ -f `which git` ] && [ -f `which rbenv` ]; then
  ...
  export PS1='\[\033[01;37m\]\w\[\033[01;33m\]$(__git_ps1 "[%s]") \[\033[01;37m\]\$\[\033[00m\] '
elif [ `which rbenv` ]; then
  export PS1='\[\033[01;33m\]$(__rbenv_ps1) \[\033[01;37m\]\w \$\[\033[00m\] '
else
  export PS1='\[\033[01;32m\]\u@\h\[\033[01;33m\] \w \[\033[01;37m\]\$\[\033[00m\] '
fi
